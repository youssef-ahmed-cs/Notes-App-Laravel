<x-layout>
    <div class="mx-auto max-w-2xl px-6 py-10">
        <div class="rounded-2xl bg-white p-8 shadow-sm ring-1 ring-gray-200 dark:bg-gray-900 dark:ring-gray-800">
            <h1 class="text-2xl font-semibold tracking-tight text-gray-900 dark:text-gray-100">
                Hello, {{ $name }} 👋
            </h1>

            <p class="mt-4 text-gray-700 dark:text-gray-300">
                Welcome to our application! We're so glad to have you 🎉
            </p>
